...
BEGIN
  ...
  VALUES (_req.user_id, 'credit', _req.amount,
    'Withdrawal refund', _request_id::text);
  ...
  VALUES (_req.user_id, 'Withdrawal Refunded',
    'Your withdrawal of KES ' || _req.amount || ' could not be completed at this time and has been refunded to your wallet. Please try again later.',
    'payment');
END;
$function$;