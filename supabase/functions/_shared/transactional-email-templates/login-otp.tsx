...
const LoginOtpEmail = ({ code = '000000' }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your {SITE_NAME} sign-in code</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={brand}><Text style={brandText}>{SITE_NAME}</Text></Section>
        <Heading style={h1}>Your sign-in code</Heading>
        <Text style={text}>
          Use the 6-digit code below to sign in to your {SITE_NAME} account. Expires in 10 minutes.
        </Text>
        <Section style={codeBox}><Text style={codeText}>{code}</Text></Section>
        <Text style={muted}>
          Didn't try to sign in? Ignore this email and consider changing your password. Never share this code.
        </Text>
