  ...
  return (
    <div className="bg-card p-6 rounded-2xl shadow-md max-w-md mx-auto my-5">
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          <label className="block text-sm font-semibold text-muted-foreground mb-1">Amount (KES)</label>
          <input
            type="number"
        ...
        <button
          ...
          className={`w-full py-3.5 rounded-xl text-base font-bold transition-all ${
            isOnline ? 'bg-primary text-primary-foreground cursor-pointer' : 'bg-muted text-muted-foreground cursor-not-allowed'
          }`}
        >
