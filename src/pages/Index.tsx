...
export default function Index() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[hsl(213,72%,8%)]">
      ...
      {/* ───── FEATURES ───── */}
      <section id="features" className="py-16 sm:py-24 md:py-28 px-4 bg-[hsl(213,72%,8%)] relative">
        <div className="container max-w-6xl">
          <motion.div className="text-center mb-10 sm:mb-16" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ duration: 0.5 }}>
            ...
            <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 text-white">Everything You Need, One Platform</h2>
      ...
      {activeHarambees.length > 0 && (
        <section className="py-16 sm:py-24 md:py-28 px-4 bg-[hsl(213,72%,8%)] relative overflow-hidden">
          <div className="container max-w-6xl">
            <motion.div className="text-center mb-8 sm:mb-12" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 text-white">Active Harambees</h2>
              <p className="text-white/65 max-w-xl mx-auto text-sm sm:text-base">Support community causes. Every contribution makes a difference.</p>
            </motion.div>
            ...
            <div className="text-center mb-6 sm:mb-8">
              ...
              <p className="text-[11px] text-white/50 mt-2">Create a verified Harambee — 3% platform fee on collected funds</p>
            </div>
              ...
              {activeHarambees.map((h, i) => {
                ...
                return (
                  <motion.div key={h.id} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }}
                    className="min-w-[260px] sm:min-w-[280px] max-w-[320px] snap-start shrink-0">
                    <div className="rounded-2xl bg-white/[0.03] border border-white/[0.06] hover:border-accent/20 transition-all duration-300 overflow-hidden flex flex-col h-full">
                      <div className="p-4 sm:p-5 flex-1 space-y-3 sm:space-y-4">
                        <div className="flex items-start justify-between gap-2">
                          ...
                          {daysLeft !== null && (
                            <span className="text-[10px] font-bold text-white/70 bg-white/[0.06] px-2 py-1 rounded-full">
                        ...
                        <div>
                          ...
                          {h.description && <p className="text-xs sm:text-sm text-white/60 mt-1 line-clamp-2">{h.description}</p>}
                        </div>
