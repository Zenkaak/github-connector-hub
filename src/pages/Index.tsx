...
export default function Index() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      // Fetch public chamas for explorer
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[hsl(213,72%,8%)]">
      ...
      {/* ───── TRUST BADGES ───── */}
      <section className="py-10 px-4 bg-[hsl(213,72%,6%)] border-y border-white/[0.04]">
        ...
        <div className="container max-w-6xl">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { icon: Wallet, title: 'Digital Wallet', desc: 'Deposit, transfer, request money. Your personal wallet with full transaction history and instant M-Pesa top-up.' },
              ...
              { icon: Heart, title: 'Harambee', desc: 'Create public fundraising campaigns. Accept contributions via M-Pesa from anyone, even non-members.' },
              { icon: Landmark, title: 'Personal Loans', desc: 'Apply for Biashara, Elimu, or Youth Fund loans directly from your dashboard. Quick approval process.' },
              { icon: Users, title: 'Role Management', desc: 'Assign Chairperson, Secretary, and Treasurer roles with specific permissions and oversight.' },
              { icon: Shield, title: 'Emergency Fund', desc: 'Automatic monthly emergency contributions. Auto-deducted from deposits to keep your group protected.' },
              { icon: Zap, title: 'Real-Time Alerts', desc: 'Instant notifications for payments, withdrawals, messages, and approvals. Never miss a beat.' },
            ].map((feature, i) => (
      ...
      {/* ───── WALLET & TRANSFERS ───── */}
      <section id="wallet" className="py-24 md:py-28 px-4 bg-[hsl(213,72%,10%)] relative overflow-hidden">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <motion.div key={i} initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
                    className="flex items-start gap-4 p-4 rounded-xl bg-white/[0.03] border border-white/[0.06] hover:border-emerald-500/20 transition-colors">
      ...
      {publicChamas.length > 0 && (
        <section className="py-24 md:py-28 px-4 bg-[hsl(213,72%,10%)] relative">
          <div className="container max-w-6xl">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {publicChamas.slice(0, 6).map((chama, i) => (
                <motion.div key={chama.id} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.06 }}
                  className="p-5 rounded-2xl bg-white/[0.03] border border-white/[0.06] hover:border-accent/20 transition-all duration-300">
      ...
      {activeHarambees.length > 0 && (
        <section className="py-24 md:py-28 px-4 bg-[hsl(213,72%,8%)] relative overflow-hidden">
          <div className="container max-w-6xl">
            <motion.div className="text-center mb-12" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
      ...
      {/* ───── FAQ ───── */}
      <section id="faq" className="py-24 md:py-28 px-4 bg-[hsl(213,72%,8%)]">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.97 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <Link to="/signup">
                  <Button variant="hero" size="xl" className="min-w-[220px] shadow-gold-lg">Create Free Account <ArrowRight size={20} /></Button>
                </Link>
                <Link to="/contact">
                  <Button variant="outline" size="xl" className="border-white/10 text-white hover:bg-white/[0.06] min-w-[160px]">Talk to Us</Button>
                </Link>
              </div>
            </div>
          </motion.div>
