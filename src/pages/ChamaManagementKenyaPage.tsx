export default function ChamaManagementKenyaPage() {
  return (
    <div style={{maxWidth:"900px",margin:"auto",padding:"40px"}}>
      ...
      <h2>Why Kenyan Chamas Need Digital Management</h2>
      ...
      <ul>
        ...
        <li>Run Harambee fundraising campaigns</li>
        <li>Manage group loans</li>
        <li>Monitor savings and investments</li>
        <li>Secure mobile money integrations</li>
      </ul>
